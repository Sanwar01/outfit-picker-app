      ...
      <div className="mx-auto max-w-md">
        ...
        <form action={signUpWithPassword} className="space-y-4">
          ...
          <button
            ...
            className="h-12 w-full rounded-2xl bg-primary text-sm font-medium text-primary-foreground transition-colors hover:bg-primary/90 disabled:cursor-not-allowed disabled:opacity-50"
          >
            Create account
          </button>
        </form>
